                    ...
                    <form class="form-horizontal" action="addmobil.php" method="post">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input id="tipe" name="tipe" type="text" placeholder="Tipe Mobil"
                                           class="form-control input-md" required="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input id="merk" name="merk" type="text" placeholder="Merek Mobil"
                                           class="form-control input-md">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input id="tahun" name="tahun" type="text" placeholder="Tahun Kendaraan"
                                           class="form-control input-md">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <select class="form-control input-md" name="kodelama"
                                    ...
                                    <section style="display:none;" disabled="disabled"
                                             onblur="if(this.value==''){toggleField(this,this.previousSibling);}"><input
                                            class="form-control input-md" name="pemilikbaru" value="Pemilik">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input id="kode" name="kode" type="text" placeholder="No KTP Pemilik"
                                                       class="form-control input-md">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input id="telp" name="telp" type="text" placeholder="Telepon Pemilik"
                                                       class="form-control input-md">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input id="alamat" name="alamat" type="text"
                                                       placeholder="Alamat Pemilik" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <button id="btn-submit" name="btn-submit" class="btn btn-primary">submit
                                            </button>
                                        </div>
                                    </div>

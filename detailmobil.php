...
{
    redirect("booking.php?id='$_GET[id]'");
}
elseif(isset($_POST['btn-back']))
{
    redirect("tampilmobiluser.php");
}
echo $output;
?>
<html>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Detail Mobil</h1>
        </div>
    </div>
    <!--/.row-->
                    ...
                    <form class="form-horizontal" action="" method="post">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <button id="btn-submit" name="btn-submit" class="btn btn-primary">Pesan</button>


                                    <div class="col-md-4">
                                        <button id="btn-back" name="btn-back" class="btn btn-primary">Kembali</button>
                                    </div>
                            </div>

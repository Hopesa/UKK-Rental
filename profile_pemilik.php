            ...
            <ul class="user-menu">
                <li class="dropdown pull-right">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>
                            <a href="profile_pemilik.php?logout">
                                <svg class="glyph stroked male-user">
                                    <use xlink:href="#stroked-male-user"></use>
                                </svg> Profile</a>
                        </li>
                        ...
                        <li>
                            <a href="profile_pemilik.php?logout">
                                <svg class="glyph stroked cancel">
                                    <use xlink:href="profile_pemilik.php?logout"></use>
                                </svg> Logout</a>
                        </li>
                    </ul>
                </li>
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        <li class="active">
            <a href="profile_pemilik.php.php">
        ...
        <li><a href="rprt_pemilik.php">Report Pemilik</a></li>
        <li><a href="rprt_peminjaman.php">Report Peminjaman</a></li>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <form class="col-md-8" method="post" action="profile_pemilik.php?update">
                ...
                if(isset($_GET['update'])) {
                    ...
                    if(isset($_POST['pass'])){
                        if ((updatePassPemilik($oldpass)) == true) {
                        ...
                        if ((updatePemilik($nama, $alamat, $telp)) == true) {
